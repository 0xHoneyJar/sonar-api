...
2. Parse AGENTS.md for operator markers (skip a loa-generated AGENTS.md whose first line contains `generated by agents-md-gen.sh` — it is loa's own governance projection, not an operator marker)
