# Invisible Retrospective — Steps 3-5 (Postlude Detail)

Relocated from implementing-tasks SKILL.md `<retrospective_postlude>`. Steps 1-2
(config check + session scan) remain in the SKILL body. Read this file before
writing ANY learning content to disk and apply Step 3.5 sanitization first.
