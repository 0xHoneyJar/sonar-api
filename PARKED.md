...
2026-07-28 — Mibera staking (paddlefi/jiko) special case removed from the ERC-721 handler at bd-dwq5.3; staked Mibera NFTs will attribute to the staking contract as holder on the next re-index instead of to the staker — sonar src/handlers/tracked-erc721.ts
