---
title: NOTES ledger archive
archived: 2026-07-19
reason: erasure pass — agent intake compressed to ARRIVAL.md; operator history preserved here
---

# Archived Session Ledger (through 2026-07-19)

> Agents: **do not read this file** unless a bead/PR explicitly cites a date here.
> Live continuity: `grimoires/loa/NOTES.md` (short). Door: `grimoires/loa/ARRIVAL.md`.
