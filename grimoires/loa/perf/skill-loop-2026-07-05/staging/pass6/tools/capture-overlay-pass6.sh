...
# pass-6 staged overlay (pre-install verification)
cp "/home/merlin/Documents/thj/code/loa/grimoires/loa/perf/skill-loop-2026-07-05/staging/pass6/zone-write-guard.sh" "$M/.claude/hooks/safety/zone-write-guard.sh"
cp "/home/merlin/Documents/thj/code/loa/grimoires/loa/perf/skill-loop-2026-07-05/staging/pass6/karpathy-surgical-diff-check.sh" "$M/.claude/hooks/quality/karpathy-surgical-diff-check.sh"
chmod +x "$M/.claude/hooks/safety/zone-write-guard.sh" "$M/.claude/hooks/quality/karpathy-surgical-diff-check.sh"
H="$M/.claude/hooks"
