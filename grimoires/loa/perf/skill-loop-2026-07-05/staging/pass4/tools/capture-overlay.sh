...
PERF_DIR="/home/merlin/Documents/thj/code/loa/grimoires/loa/perf/skill-loop-2026-07-05"
MODE="capture"
...
# pass-4 staged overlay (pre-install verification)
cp "/home/merlin/Documents/thj/code/loa/grimoires/loa/perf/skill-loop-2026-07-05/staging/pass4/settings-cleanup.sh" "$M/.claude/hooks/hygiene/settings-cleanup.sh"
cp "/home/merlin/Documents/thj/code/loa/grimoires/loa/perf/skill-loop-2026-07-05/staging/pass4/post-compact-reminder.sh" "$M/.claude/hooks/post-compact-reminder.sh"
cp "/home/merlin/Documents/thj/code/loa/grimoires/loa/perf/skill-loop-2026-07-05/staging/pass4/mutation-logger.sh" "$M/.claude/hooks/audit/mutation-logger.sh"
cp "/home/merlin/Documents/thj/code/loa/grimoires/loa/perf/skill-loop-2026-07-05/staging/pass4/write-mutation-logger.sh" "$M/.claude/hooks/audit/write-mutation-logger.sh"
cp "/home/merlin/Documents/thj/code/loa/grimoires/loa/perf/skill-loop-2026-07-05/staging/pass4/karpathy-surgical-diff-check.sh" "$M/.claude/hooks/quality/karpathy-surgical-diff-check.sh"
cp "/home/merlin/Documents/thj/code/loa/grimoires/loa/perf/skill-loop-2026-07-05/staging/pass4/cleanup-context.sh" "$M/.claude/scripts/cleanup-context.sh"
H="$M/.claude/hooks"
