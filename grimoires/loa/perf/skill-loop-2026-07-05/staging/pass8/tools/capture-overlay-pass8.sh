...
# pass-8 staged overlay (pre-install verification)
cp "/home/merlin/Documents/thj/code/loa/grimoires/loa/perf/skill-loop-2026-07-05/staging/pass8/block-destructive-bash.sh" "$M/.claude/hooks/safety/block-destructive-bash.sh"
chmod +x "$M/.claude/hooks/safety/block-destructive-bash.sh"
H="$M/.claude/hooks"
