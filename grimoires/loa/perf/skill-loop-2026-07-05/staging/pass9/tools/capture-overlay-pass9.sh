...
# pass-9 staged overlay (pre-install verification)
cp "/home/merlin/Documents/thj/code/loa/grimoires/loa/perf/skill-loop-2026-07-05/staging/pass9/adversarial-review-gate.sh" "$M/.claude/hooks/safety/adversarial-review-gate.sh"
cp "/home/merlin/Documents/thj/code/loa/grimoires/loa/perf/skill-loop-2026-07-05/staging/pass9/spiral-skill-sentinel.sh" "$M/.claude/hooks/safety/spiral-skill-sentinel.sh"
cp "/home/merlin/Documents/thj/code/loa/grimoires/loa/perf/skill-loop-2026-07-05/staging/pass9/mutation-logger.sh" "$M/.claude/hooks/audit/mutation-logger.sh"
chmod +x "$M/.claude/hooks/safety/adversarial-review-gate.sh" "$M/.claude/hooks/safety/spiral-skill-sentinel.sh" "$M/.claude/hooks/audit/mutation-logger.sh"
H="$M/.claude/hooks"
