 ...
 * 3-10. MiReveal phases 1 through 8
 *
 * ============================================================
 */

export type TrackedErc721CollectionIdentityV1<
  CanonicalKey extends string,
  AcceptedKeys extends readonly [CanonicalKey, ...string[]],
> = Readonly<{
  schemaVersion: 1;
  address: `0x${string}`;
  canonicalKey: CanonicalKey;
  acceptedKeys: AcceptedKeys;
  emittedKey: AcceptedKeys[number];
}>;

/**
 * Phase 8 is canonically MiReveal #6.9, while existing Score consumers read
 * `mireveal_6_6`. Only `emittedKey` feeds the live wire map below; changing it
 * is a separate, consumer-gated migration.
 */
export const FRACTURES_PHASE_8_IDENTITY_V1 = {
  schemaVersion: 1,
...
} as const satisfies TrackedErc721CollectionIdentityV1<
  "mireveal_6_9",
  readonly ["mireveal_6_9", "mireveal_6_6"]
>;
...
export const TRACKED_ERC721_COLLECTION_KEYS: Record<string, string> = {
  ...
  [FRACTURES_PHASE_8_IDENTITY_V1.address]:
    FRACTURES_PHASE_8_IDENTITY_V1.emittedKey, // fracture #8
