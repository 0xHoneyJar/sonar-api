...
export type Marketplace = "seaport" | "blur";
 ...
 *
 * BLUR — Ethereum only. Blur never deployed to an L2; its volume is mainnet
 * NFT trading, which is exactly the coverage Seaport-only was missing.
 */
// prettier-ignore
export const MARKETPLACES: readonly MarketplaceDeployment[] = [
  ...
  { marketplace: "blur",    label: "Blur Marketplace",   address: "0x000000000000ad05ccc4f10045630fb830b95127", chain: 1, startBlock: 15779200 },
  { marketplace: "blur",    label: "Blur Marketplace 2", address: "0x39da41747a83aee658334415666f3ef92dd0d541", chain: 1, startBlock: 17262000 },
